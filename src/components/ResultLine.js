  ...
  return (
    <div className="resultLine">
      <div className="previewContainer">
        {book.edition_key ? <Link to={`/book/${book.edition_key[0]}`}><img className="previewImage" src={book.cover_edition_key ? `http://covers.openlibrary.org/b/OLID/${book.cover_edition_key}-M.jpg` : '/nia.jpg' } /></Link> : <img className="previewImage" src={book.cover_edition_key ? `http://covers.openlibrary.org/b/OLID/${book.cover_edition_key}-M.jpg` : '/nia.jpg' } />}
      </div>
      <span className="previewTitle">{book.edition_key ? <Link to={`/book/${book.edition_key[0]}`}>{book.title}</Link> : book.title}</span>
